...
from modules.strategy_profiles import get_strategy_profile  # ✅ 加入策略模組

def analyze_stocks_with_signals(mode="opening"):
    print("[signal_analysis] ✅ 開始整合分析流程...")

    # 取得該時段的策略設定
    strategy = get_strategy_profile(mode=mode)

    min_turnover = 50_000_000
    limit = strategy.get("price_limit", 100)
    ...
    final_df = calculate_technical_scores(df, strategy=strategy)  # ✅ 傳入策略權重
