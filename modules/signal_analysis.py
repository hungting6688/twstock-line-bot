...
def analyze_stocks_with_signals(mode="opening", **kwargs):
    ...
    min_turnover = kwargs.get("min_turnover", 50_000_000)
    min_score = kwargs.get("min_score", profile["min_score"])
    eps_limit = kwargs.get("eps_limit", profile["eps_limit"])
    limit = kwargs.get("limit", profile["price_limit"])
