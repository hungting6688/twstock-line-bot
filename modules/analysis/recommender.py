...
class StockRecommender:
    ...
    def _noon_strategy(count):
        ...
        print(f"[stock_recommender] 分析午盤技術指標 (掃描{scan_limit}檔股票)...")
    ...
    def _afternoon_strategy(count):
        ...
        print(f"[stock_recommender] 分析尾盤技術指標 (掃描{scan_limit}檔股票)...")
        tech_results = analyze_technical_indicators(stock_ids)
    ...
    def _evening_strategy(count):
        ...
        print(f"[stock_recommender] 分析盤後技術指標 (掃描{scan_limit}檔股票)...")
        tech_results = analyze_technical_indicators(stock_ids)
